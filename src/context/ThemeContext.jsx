...
const THEME_STORAGE_KEY = "autods-theme-version";
...
const ThemeContextProvider = (props) => {
  ...
  useEffect(() => {
    body.setAttribute("data-theme-version", background.value);
    window.localStorage.setItem(THEME_STORAGE_KEY, background.value);
  }, [background, body]);
