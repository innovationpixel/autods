...
function MarketplaceContent({
  ...
  const ebayProductCards = ebayItems.map((item) => ({
    ...
    rating: item.rating ?? item.seller_feedback_percentage ?? null,
    reviews: item.reviews ?? item.seller_feedback_score ?? null,
    stock: item.stock ?? item.quantity ?? null,
    isChoice: Boolean(item.is_choice || item.isChoice || item.choice),
