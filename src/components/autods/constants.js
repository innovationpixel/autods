...
export const orderRowBoltActions = [
  ...
  { id: "send-ebay-invoice", label: "Send eBay Invoice" },
...
export const productSeedItems = [
  ...
  },
  {
    ...
    outOfStock: 0,
    total: 2,
    priceBuy: "$11.09 - $11.19",
    priceSell: "$11.09 - $11.19",
    sold: 0,
    dws: 4,
    profit: "-",
    tags: "-",
  ...
  },
  {
    ...
    outOfStock: 0,
    total: 10,
    priceBuy: "$15.99 - $20.49",
    priceSell: "$15.99 - $20.49",
    sold: 0,
    dws: 4,
    profit: "-",
    tags: "-",
